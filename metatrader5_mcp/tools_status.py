...
def mt5_health_check() -> dict[str, Any]:
    ...
    health_status["checks"]["terminal_connected"] = terminal_dict.get("connected", False)
    ...
    elif health_status["checks"]["terminal_initialized"] and health_status["checks"]["terminal_connected"]:
